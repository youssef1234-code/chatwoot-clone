  ...
  <div class="flex flex-1 overflow-auto">
    ...
    >
      ...
      <div class="text-right mb-2">
        <button @click="alignText('left')">Left</button>
        <button @click="alignText('center')">Center</button>
        <button @click="alignText('right')">Right</button>
      </div>
...
export default {
  ...
  methods: {
    ...
    alignText(align) {
      ...
      // You can apply the alignment to your article editor or any specific element as needed
    },
  },
};
</script>
